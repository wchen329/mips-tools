...
#define PRISCAS_BRANDING_FULL_VERSION_STRING "0.3.552.4001"
#define PRISCAS_BRANDING_COPYRIGHT "Copyright (c) 2019 Winor Chen"
#define PRISCAS_BRANDING_FULL_VERSION 0,3,552,4001
...
namespace branding
{
	...
	const std::string APPLICATION_VERSION = std::string("ECE 552 Edition");
