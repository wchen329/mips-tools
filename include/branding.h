...
#define PRISCAS_BRANDING_FULL_VERSION_STRING "0.3.552.4000"
#define PRISCAS_BRANDING_COPYRIGHT "Copyright (c) 2019 Winor Chen"
#define PRISCAS_BRANDING_FULL_VERSION 0,3,552,4000
...
namespace branding
{
	...
	const std::string APPLICATION_VERSION = std::string("ECE552 Edition RC1");
