...
namespace branding
{
	const std::string APPLICATION_NAME = priscas::UPString("PRISCAS");
	const std::string APPLICATION_DESC = priscas::UPString("[PRISCAS Reduced Instruction Set Computer Architecture Simulator]");
	const std::string APPLICATION_VERSION = priscas::UPString("0.4");
